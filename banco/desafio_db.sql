...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Mar-2023 às 18:29
...
ALTER TABLE `adresses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `adresses_client_id_foreign` (`client_id`);
...
--
ALTER TABLE `adresses`
  ADD CONSTRAINT `adresses_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`);
